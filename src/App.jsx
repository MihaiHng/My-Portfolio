            ...
            <div className="col-lg-6 col-12 mb-4 text-center">
              <div className="d-flex flex-column flex-lg-row align-items-center border-0 p-4 border rounded">
                ...
                <div className="text-lg-start text-center order-1 order-lg-1 w-100">
                  <h2 className="fw-bold fs-3">Hi, I'm Mihai Hanga</h2>
                  <hr></hr>
                  <p className="lead">A blockchain enthusiast looking to become a blockchain developer by:</p>
                  <p><i className="bi bi-arrow-right-circle me-2"></i>Finding blockchain developer opportunities where I can learn from experienced professionals</p>
                  <p><i className="bi bi-arrow-right-circle me-2"></i>Developing my coding skills in the blockchain area</p>
                  <p><i className="bi bi-arrow-right-circle me-2"></i>Connecting with like minded people in the web3 space</p>
                </div>
              </div>
                ...
                <div className="accordion-item mx-3" style={{ fontSize: '0.9rem', backgroundColor: 'transparent', borderColor: '#6c757d'}}>
                  ...
                  <div id="collapseOne" className="accordion-collapse collapse" data-bs-parent="#aboutMe">
                    <div className="accordion-body text-start py-1 border-0">
                      I started being interested in blockchain a few years ago, but then it evolved into something more when I 
            ...
            <div className="col-lg-6 col-12 mb-4 text-center">
              ...
              <div className="card bg-transparent border-dark mx-5">
                ...
                <div className="card-body d-flex justify-content-start align-items-start flex-wrap gap-3">
                    ...
                    <button type="button" className="btn rounded-pill btn-secondary shadow">CRA</button>
